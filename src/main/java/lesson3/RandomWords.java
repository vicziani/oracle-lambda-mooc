...
public class RandomWords {
  ...
  public RandomWords() throws IOException {   
    try (BufferedReader reader = new BufferedReader(new InputStreamReader(RandomWords.class.getResourceAsStream("words")))) {
  ...
  public List<String> createList(int listSize) {
    ...
    List<String> wordList = rand.ints(0, sourceWords.size()).mapToObj(i -> sourceWords.get(i)).limit(listSize).collect(Collectors.toList());
